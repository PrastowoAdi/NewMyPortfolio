...
export default function DescribeMe() {
  return (
    <p className="font-medium text-secondary mb-5 leading-relaxed">
      ...
      learned the Java programming language, after that I was assigned to{" "}
      <span className="font-semibold">PT. Bank Negara Indonesia</span> to become
      B24 Developer until now.
    </p>
  );
}
